...
namespace PROJECT.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        //private SocialMediaDbContext SocialMediaDb = new SocialMediaDbContext();
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    ...
                    List <string> onlineUsers = HttpContext.Application["OnlineUsers"] as List<string>;
        ...
        {
            //var users = (from user in ApplicationDb.Users select new { user.NickName }).ToList();
            //var nickname = model.NickName;
            //foreach(var user in users)
            //{
              //  if (user.NickName == nickname)
                //{
                  //  ModelState.AddModelError("NickName", "NickName AlreadyTaken");
                    //return View(model);
                //}
            //}
            if (ModelState.IsValid)
